...
function call(){
    ...
    setTimeout(function(){body.classList.remove("flashbackground");
audio.play();},500);
}
function checkans(idx){
    ...
    if(userseq[idx]===gameseq[idx]){
        ...
        levelUp();score=score+2;}
    }
    else{head.innerText="Game Over! Press any Key to Start";

    displayscore();
    call();

started=false;gameseq=[];userseq=[];level=0;score=0;
}
}
